...
wget -O /usr/local/bin/ws "http://raw.githubusercontent.com/titis69/liwung2025/main/sshws/ws"
...
wget -O /usr/local/bin/ws-ovpn "http://raw.githubusercontent.com/titis69/liwung2025/main/sshws/ws"
