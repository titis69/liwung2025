...
wget -O /usr/local/bin/ws "http://raw.githubusercontent.com/GANTI PAKAI REPO MU/main/sshws/ws"
...
wget -O /usr/local/bin/ws-ovpn "http://raw.githubusercontent.com/GANTI PAKAI REPO MU/main/sshws/ws"
