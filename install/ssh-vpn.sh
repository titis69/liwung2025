...
REPO2="https://raw.githubusercontent.com/titis69/liwung2025/main/install/autocpu.sh"
# initializing var
...
wget -O /etc/haproxy/haproxy.cfg "https://raw.githubusercontent.com/GANTI PAKAI REPO MU/main/install/haproxy.cfg"
